...
<body>
    <header class="flexbetween aligncenter blur30">
        ...
        <form action="crud-emp.php" method="get" name="searchForm" class="flexbetween algincenter">
            <input type="text" name="search" id="search" placeholder="Nome da empresa">
    ...
    <main>
        <table>
            ...
            $searchQuery = "SELECT id, nome, email, cpf, cnpj FROM usuario WHERE acesso = 'enterprise'";
            $bindParams = [];
            ...
            if ($usuarios && count($usuarios) > 0) {
                ...
                echo "<tr><td colspan='9'>Nenhuma empresa encontrada.</td></tr>";
            }
            ?>
        </table>
    </main>
