...
<body>
    <header class="flexbetween aligncenter blur30">
        ...
        <form action="crud-fun.php" method="get" name="searchForm" class="flexbetween algincenter">
            <input type="text" name="search" id="search" placeholder="Nome do funcionário">
    ...
    <main>
        <table>
            ...
            $searchQuery = "SELECT id, nome, email, cpf, cnpj FROM usuario WHERE acesso IN ('doorman', 'staff')";
            $bindParams = [];
